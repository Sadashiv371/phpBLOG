...
<main class="form-signin w-100 m-auto">
  <form method="post">
    <img class="mb-4 rounded-circle shadow" src="assets/images/logo.jpg" alt="" width="92" height="92" style="object-fit: cover; border-radius: 50%">
    ...
    <div class="form-floating">
      ...
      <div class="my-2">Dont have an account? <a href="signup.php"> Sign up here</a></div>
    </div>
